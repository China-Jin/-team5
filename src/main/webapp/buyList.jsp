...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="col-md-3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          <li class="nav-header"  style="font-size:12px;"><strong>设置</strong></li>
          <li ><a href="">个人信息</a></li>
          <li class="active"><a href="coupon.jsp">收货地址</a></li>
          <li><a href="myvip.jsp">消费记录</a></li>
           <li><a href="myvip.jsp">账户安全</a></li>
            <li><a href="myvip.jsp">账户绑定</a></li>
             <li><a href="myvip.jsp">我的级别</a></li>
        </ul>
      </div>
      <!--/.well --> 
    </div>
    ...
    <div class="col-md-9">
    	<div class="jumbotron">
           <input type="button"  class="btn btn-default" style="background-color:#F0F9E9; float:left" value="新增收货地址"
                   onclick=" show('light')"/><br/>
           <h4 >您已创建<span style="color:#8FB25D">1</span>个收货地址，最多可创建<span style="color:#8FB25D">20</span>个</h4>
           <div class="container">
           	<div style=" border:1px solid #E45050; width:900px; height:200px; ">
            	<h3>张三 浙江 <img src="images/tool.png"/></h3>
                  <div class="smc" style="float:left; width:80%">
                	<div class="detals" style="float:left; margin-top:5px; margin-left:45px;width:320px">
                    	<div class="items" style="margin-left:16px">
                        	<span class="label1">收货人:</span>
                            <div class="data"id="item1">张三</div>
                        </div>
                        <div class="items" >
                        	<span class="label1">所在地区:</span>
                            <div class="data" style=" margin-left:76px"id="item2">浙江省杭州市上城区</div>
                        </div>
                        <div class="items" style="margin-left:28px">
                        	<span class="label1">地址:</span>
                            <div class="data" style="margin-left:48px"id="item3">荷花东路182幢5单元2102</div>
                        </div>
                        <div class="items" style=" margin-left:28px">
                        	<span class="label1">手机:</span>
                            <div class="data" style="margin-left:48px"id="item4">15988888888</div>
                        </div>
                        <div class="items" >
                        	<span class="label1">固定电话:</span>
                            <div class="data" style="margin-left:76px"id="item5">0571-666666666</div>
                        </div>
                        <div class="items" >
                        	<span class="label1">电子邮箱:</span>
                            <div class="data" style="margin-left:76px"id="item6">safacsaqw@sina.com</div>
                        </div>
                    </div>
                    <div class="send-way">
                    	 <div class="items" >
                        	<span class="label1">支付方式:</span>
                            <div class="data"id="item7">&nbsp;</div>
                        </div>
                         <div class="items" >
                        	<span class="label1">配送方式:</span>
                            <div>
                            	<div class="data" style="margin-left:72px"id="item8">京配区域内由京东快递配送</div>
                                <div class="data"id="item8" style="margin-left:72px">京配区域内由京东快递配送</div>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <div id="extra">
            ...
            <div id="light" class="white_content">
              <div class="close"><a href="javascript:void(0)" style="font-size:30px;" onclick="hide('light')"> ×</a></div>
              <div class="con">
                
               <div style="background-color:#F3F3F3;"><h5>添加收货地址</h5></div>
               <form role="form">
               <div class="form-group">
               <label id="resuser" >收货人：</label>
               <input type="text" id="resuser_text"  />
               </div>
               <div>
               <label id="destinction">所在地区:</label>
               <div class="form-group">
                ...
                <div class="form-group">
               <label id="detail_destination" >详细收货地址：</label>
               <input type="text" id="detail_destination_text" class="form-control"/>
               </div>
               <div class="form-group">
               <label id="tel" >手机号码：</label>
               <input type="text" id="tel_text" />
               </div>
               <div class="form-group">
               <label id="phone" >或固定电话：</label>
               <input type="text" id="phone_text" />
               </div>
               <div class="form-group">
               <label id="other" >地址别名：</label>
               <input type="text" id="other_text" />
               <label id="alternative_name" >建议填写常用名称</label>
               <input type="button" id="home_text" value="家里"  class="btn btn-default btn-group-sm"/>
               <input type="button" id="parent_text" value="父母家" class="btn btn-default btn-group-sm" />
               <input type="button" id="work_text" value="公司"  class="btn btn-default btn-group-sm"/>
               </div>
               <div class="form-group">
               <input type="submit" id="antherAdress" value="保存收货地址"  class="btn btn-default" />
               </div>
               </form>
              </div>
            </div>
