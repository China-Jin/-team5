...
<li>
  <div class="search">
    ...
    <button class=" btn btn-danger" style=" margin-top:30px;"><a href="product_list.jsp">reserch</a></button>
      ...
      <div class="row-fluid">
        <div class=" col-md-3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="spend.jsp">消费记录</a></li>
              <li><a href="focus.jsp">我的关注</a></li>
              <li class="active"><a href="orderForm.jsp">我的订单</a></li>
              <li><a href="">账户设置</a></li>
              <li><a href="">建议反馈</a></li>
            </ul>
          </div><!--/.well -->
        ...
        <h3>我的订单</h3>
          <div class="hero-unit">  
            ...
            <div class="orderForm-bj1" style="margin-top:20px; height:700px" id="order02">
          <!--订单类型-->
          <div class="blank-space1"></div>
          <div class="orderForm-type">
            <ul class="ul1" style="float:left">
              <li><a style="margin-left:10px" href="#" class="txt">全部订单</a></li>
              <li><a href="#" class="txt" id="ordertoPay">待付款</a></li>
              <li><a href="#" class="txt" id="ordertoPay">待发货</a></li>
              <li><a href="#" class="txt" id="ordertoReceive">待收货</a></li>
              <li style=""><a href="#" class="txt" id="ordertoComment" target="_blank">待评价</a></li>
              <li ><a style="margin-left:50px;border-right:1px dashed #000;"></a></li>
              <li><a class="text" style="color: #000; margin-left: 30px; font-weight: bold;">常购的商品</a></li>
              <li ><a style="margin-left:20px;border-right:1px dashed #000;"></a></li>
              <li style="margin-left: 25px; "><a class="gc-txt" href="#">订单回收站</a></li>
              <li></li>
            </ul>
            <div style="float: right; margin-top: 0px;" class="search" >
              <input type="text" placeholder="商品名称/商品编号/订单号" class="input_text" />
              <a href="javascript:void(0);" class="a1"><img src="images/reserch.png" /></a> <a href="javascript:void(0);" class="a2">高级</a> </div>
          </div>
          <div style=" margin-left:40px;margin-top:20px; background-color:#F9F9F9; width:88%; height:30px;font-weight:normal; font-size:12px">
          	<ul style="margin-top:5px; margin-left:10px; float:left">
      <li class="my bj"> <a href="#" style="font-size:13px; margin-top:10px; margin-left:15px; margin-right:10px">近三个月订单</a> <i class="ci-right "> <s class="jt">◇</s> </i>
   <div class="my1">
    <ul class="neirong2">
      <li><a href="">近三个月</a></li>
      <li><a href="">今年内订单</a></li>
      <li><a href="">2015年订单</a></li>
    </ul>
  </div>
    </li>
     </ul>
    <div class="form-detail">
      <div style="float:left;margin-top:6px">订单详情</div>
      <div class="form-detail1" style="margin-left: 200px">收货人</div>
      <div class="form-detail2">金额</div>
      <div class="form-detail2" >状态</div>
      <div class="form-detail2" style="position: absolute;left:820px">操作</div>
    </div>
          </div>
          
<table class="table table-hover" style="font-weight:normal; width:95%; color:#000; margin-right:200px">
  <thead>
    <tr style="font-size:14px">
      <th>订单号：</th>
      <th id="formID1">201609010002</th>
      <th id="shopname1">苹果手机专卖店</th>
    </tr>
  </thead>
  <tbody>
    <tr class="active" >
      <td style="width:60px"><div class="icon"><a id="photo1" href="javascript:void(0);"><img src="images/reserch.png" alt="" /></a></div></td>
                <td style="width:290px"><div class="detail-neirong" id="detail_neirong1" style="width:200px; float:left">详情按时发生次阿萨斯擦上是否ds;儿童擦</div>
                <div id="number1" style="margin-left:50px; margin-top:20px">1</div></td></td>
      <td style="width: 160px"><div id="tuihuan1" style="margin-left:30px; font-size:12px; margin-right:15px; margin-top:25px">返修/退换货</div></td>
      <td>
      	<div id="user1" style="width:80px; font-weight:normal; font-size:14px; margin-top:25px">收货人1</div>
        </td>
     	<td><div id="price1" style="width:60px; margin-right:20px; margin-top:25px">1000.00</div></td>
     	 <td>
                	<div class="zt" id="zt1" style="margin-right:88px; margin-top:25px">待收货</div>
                </td>
      <td><div class="chacha">×</div></td>
    </tr>
    
  <thead>
    <tr style="font-size:14px">
      <th>订单号：</th>
      <th id="formID2">201609010002</th>
      <th id="shopname2">苹果手机专卖店</th>
    </tr>
  </thead>
  <tbody>
   <tr class="success">
      <td style="width:60px"><div class="icon"><a id="photo2" href="javascript:void(0);"><img src="images/reserch.png" alt="" /></a></div></td>
                <td style="width:290px"><div class="detail-neirong" id="detail_neirong2" style="width:200px; float:left">详情按时发生次阿萨斯擦上是否ds;儿童擦</div>
                <div id="number2" style="margin-left:50px; margin-top:20px">2</div></td></td>
      <td style="width: 160px"><div id="tuihuan2" style="margin-left:30px; font-size:12px; margin-right:15px; margin-top:25px">返修/退换货</div></td>
      <td>
      	<div id="user2" style="width:80px; font-weight:normal; font-size:14px; margin-top:25px">收货人1</div>
        </td>
     	<td><div id="price2" style="width:60px; margin-right:20px; margin-top:25px">1000.00</div></td>
     	 <td>
                	<div class="zt" id="zt2" style="margin-right:88px; margin-top:25px">已完成</div>
                </td>
      <td><div class="chacha">×</div></td>
    </tr>
    <thead>
    <tr style="font-size:14px">
      <th>订单号：</th>
      <th id="formID4">201609010002</th>
      <th id="shopname4">苹果手机专卖店</th>
    </tr>
  </thead>
  <tbody>
   <tr class="warning">
      <td style="width:60px"><div class="icon"><a id="photo4" href="javascript:void(0);"><img src="images/reserch.png" alt="" /></a></div></td>
                <td style="width:290px"><div class="detail-neirong" id="detail_neirong4" style="width:200px; float:left">详情按时发生次阿萨斯擦上是否ds;儿童擦</div>
                <div id="number4" style="margin-left:50px; margin-top:20px">4</div></td></td>
      <td style="width: 160px"><div id="tuihuan4" style="margin-left:30px; font-size:12px; margin-right:15px; margin-top:25px">返修/退换货</div></td>
      <td>
      	<div id="user4" style="width:80px; font-weight:normal; font-size:14px; margin-top:25px">收货人1</div>
        </td>
     	<td><div id="price4" style="width:60px; margin-right:20px; margin-top:25px">1000.00</div></td>
     	 <td>
                	<div class="zt" id="zt4" style="margin-right:88px; margin-top:25px">待确认</div>
                </td>
      <td><div class="chacha">×</div></td>
    </tr>
  <thead>
    <tr style="font-size:14px">
      <th>订单号：</th>
      <th id="formID">201609010002</th>
      <th id="shopname">苹果手机专卖店</th>
    </tr>
  </thead>
  <tbody>
    <tr class="danger">
      <td style="width:60px"><div class="icon"><a id="photo3" href="javascript:void(0);"><img src="images/reserch.png" alt="" /></a></div></td>
                <td style="width:290px"><div class="detail-neirong" id="detail_neirong3" style="width:200px; float:left">详情按时发生次阿萨斯擦上是否ds;儿童擦</div>
                <div id="number3" style="margin-left:50px; margin-top:20px">3</div></td></td>
      <td style="width: 160px"><div id="tuihuan3" style="margin-left:30px; font-size:12px; margin-right:15px; margin-top:25px">返修/退换货</div></td>
      <td>
      	<div id="user3" style="width:80px; font-weight:normal; font-size:14px; margin-top:25px">收货人1</div>
        </td>
     	<td><div id="price3" style="width:60px; margin-right:20px; margin-top:25px">1000.00</div></td>
     	 <td>
                	<div class="zt" id="zt3" style="margin-right:88px; margin-top:25px">待评价</div>
                </td>
      <td><div class="chacha">×</div></td>
    </tr>
  </tbody>
