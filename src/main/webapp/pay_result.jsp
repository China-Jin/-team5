...
<div id="mainBody" style="background-color:#F9F9F9">
	<div style="background:#F9F9F9;
     margin-right:13%; margin-left:13%; margin-top:30px; height:auto">
	  <div style="background-color:#FFF; margin-top:20px; margin-left:10px; margin-right:10px; height:400px">
      	<div style="height:30px"></div>
      	<div style="margin-left:15px">
        	<div style=" float:left;background-color:#0F3; background:url(images/%E6%94%AF%E4%BB%98%E6%88%90%E5%8A%9F.png); width:45px; height:30px; margin-left:40px; margin-top:5px"></div>
        <div style=" font:Arial, Helvetica, sans-serif; width:220px;margin-top:15px; margin-left:10px; color:#64DF9B">
          <h3>支付成功!</h3></div>
          
       	</div>
            <div style=" font:Arial, Helvetica, sans-serif; width:260px;margin-top:10px; margin-left:200px; color:#64DF9B">
          <h3>我们将尽快为您发货!</h3></div>
          <div style="width:85%"><div class="detals" style="float:left; margin-top:35px; margin-left:75px;width:220px">
                    	<div class="items" style="margin-left:16px">
                       	  <span class="label2">订单号：</span>
                          <div class="detail1" id="detail1">32535234523</div>
                        </div>
                        <div class="items" style="margin-left:16px; margin-top:5px">
                        	<span class="label2">支付金额：</span>
                          	<div class="detail1" id="detail2">1000.00元</div>
                        </div>
                        <div class="items" style="margin-left:16px; margin-top:5px">
                        	<span class="label2">支付方式：</span>
                          	<div class="detail1" id="detail3">在线支付</div>
                        </div>
                        <div class="items" style="margin-left:16px; margin-top:5px">
                        	<span class="label2">付款时间：</span>
                          	<div class="detail1" style="margin-left:20px;width:160px"id="detail4">2016-09-18  13:25</div>
                        </div>
        </div>
        <div style="width:152px; height:178px; float:right; margin-top:10px"id="adv_imag">
        广告图片
        </div>
        <div class="clear"></div>
        </div>
        <div style="background-color:#099">
        	<ul class="header-right" style="margin-right:400px">
                ...
                <li class="shu"></li>
                <li class="denglu"><a href="#">做任务获取优惠券</a></li>
    		</ul>
        </div>
          	<div>---------------------------------------------------------------------------------------------------------------</div>
