...
<div>验证身份</div>
           <form action="forgetpass_3.jsp">
            <tbody>
            	<tr>
                	<td>请选择验证身份方式: </span></td>
                    <td><select name="mothod">已验证手机</select></td>
                    <td><span><input type="button" class="btn-link"id = "sendcode" value="发送验证码" /></span>
                    <div>
                    <td>昵称：<span>wangwang</span></td>
                    </div>
                    <div>
                    <td>已验证手机号：<span>13588021122</span></td>
                    </div>
                ...
                <tr>
                	<td>手机验证码:</td>
                    <td><input type ="text" id = "ecode" name = "ecode" style="height:30px;" placeholder="验证码"/> </td>
                </tr>
			...
			<div style="text-align:center">
            	<input type ="submit" class=" btn btn-default"  style="background-color:#F1F9EA"id = "next" value = "提交" />
            </div>
            </form>
		</div>
	</div>
