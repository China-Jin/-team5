...
<header id="header">
  <div class="header-box">
    ...
    <ul class="header-right">
      <li class="denglu"><a href="login.html">您好，请登录</a> <a href="register.html"  class="red">免费注册</a></li>
      <li class="shu"></li>
      <li class="denglu"><a href="orderForm.html">我的订单</a></li>
      <li class="shu"></li>
      <li class="my bj"> <a href="user.html">我的京东</a> <i class="ci-right "> <s class="jt">◇</s> </i>
        <div class="my1">
          <div class="my2"> <img src="./images/no-img_mid_.jpg">
            <div class="my3">
              <h5 class="neirong2"><a href="login.html">您好请登录</a></h5>
              <p class="neirong2"><a href="coupon.html">优惠卷 丨 消息</a></p>
            </div>
          </div>
          <ul class="neirong2">
            ...
            <li><a href="">客服咨询</a></li>
            <li><a href="buyList.html">我的收货地址</a></li>
            <li><a href="user.html">我的余额</a></li>
            <li><a href="focus.html">我的关注</a></li>
...
<div class="top-ba">
<ul class="header-right">
<li><a href="index.html"><img src="images/jd.png"/></a></li>
<li style=" margin-top:30px;">
  <h4><a href="user.html" >我的京东</a></h4>
</li>
<li  style=" margin-top:30px;">
  <h4><a href="index.html" >返回京东首页</a></h4>
</li >
<li  style=" margin-top:30px;">
  <h4><a href="index.html" >首页</a></h4>
</li>
<li class="my bj"  style=" margin-top:30px;"> <a href="myinfo.html">账户设置</a> <i class="ci-right "> <s class="jt">◇</s> </i>
  <div class="my1">
    <ul class="neirong2">
      <li><a href="myinfo.html">个人信息</a></li>
      <li><a href="buyList.html">收货地址</a></li>
      <li><a href="spend.html">消费记录</a></li>
      <li><a href="user.html">我的余额</a></li>
      <li><a href="orderForm.html">我的订单</a></li>     
    </ul>
  </div>
...
<li>
  <div class="search">
    ...
    <button class=" btn btn-danger" style=" margin-top:30px;"><a href="product_list.html">搜索</a></button>
        ...
        <div class=" col-md-2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="spend.html">消费记录</a></li>
              <li><a href="focus.html">我的关注</a></li>
              <li class="active"><a href="orderForm.html">我的订单</a></li>
              <li><a href="">账户设置</a></li>
              <li><a href="">建议反馈</a></li>
            </ul>
          </div><!--/.well -->
...
<div id="mainBody" >
	<div class="container well">
        	...
        	<div class="page-header" style="float:left; margin-top:0px"><h3>订单编号:</h3></div>
            <div class="header-formID" id="formID"style=" ">201609180001</div>
            <div class="clear"></div>
        
	<div class="row">
    <div style="float:left; font-size:16px; margin-left:25px">
    订单内容：</div>
	<div style="float:right; margin-right:18%" id="formtype">待收货</div>
    <div style="float:right">订单状态：</div>
    <div class="container">
   ...
   <div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="table table-hover table-bordered">
					      <thead>
					        <tr>
					          <th style="width:12%" ><div style="margin-left:25px">商品编号</div></th>
                              <th width="15%">&nbsp;</th>
					          <th width="13%"><div style="margin-left:20px">商品名称</div></th>
					          <th width="30%" ><div style="margin-left:30%; margin-right:30%">商品样式</div></th>
                              
					          <th width="10%">购买数量</th>	
                              <th width="12%"><div style=" margin-left:30%">总价</div></th>				     
					        </tr>
					      </thead>
					      <tbody>
					        <tr>
					          <td><div id="goods1" style="margin:25%">206786</div></td>
                              <td><label id="trade-icon1"><img src="images/55b7540cNe946ed46.jpg" /></label></td>
                              <td>
                              	<label><a id="tradename1"> 【京东超市】沙宣洗发水修护水养750ml</a> </label>
                              	<label id="price1" style="margin-top:15px">￥2599.00</label></td>
					          <td>
                              	<div id="type11" class="trade-types">商品层级1</div>
                                <div id="type12" class="trade-types">商品层级2</div>
                                <div id="type13" class="trade-types">商品层级3</div>
                                <div id="type14" class="trade-types">商品层级4</div>
                              </td>	
                              <td><label id="buynum1" style="margin:40%">1</label></td>
					          <td><label id="amount1" style="margin-left:25%; margin-top:35%">2599.00</label></td>	
                             				     		         		   
					        </tr>
					       <tr>
					          <td><div id="goods2" style="margin:25%">206786</div></td>
                              <td><label id="trade-icon2"><img src="images/55b7540cNe946ed46.jpg" /></label></td>
                              <td>
                              	<label><a id="tradename2"> 【京东超市】沙宣洗发水修护水养750ml</a> </label>
                              	<label id="price2" style="margin-top:15px">￥2599.00</label></td>
					          <td>
                              	<div id="type21" class="trade-types">商品层级1</div>
                                <div id="type22" class="trade-types">商品层级2</div>
                                <div id="type23" class="trade-types">商品层级3</div>
                                <div id="type24" class="trade-types">商品层级4</div>
                              </td>	
                              <td><label id="buynum1" style="margin:40%">1</label></td>
					          <td><label id="amount1" style="margin-left:25%; margin-top:35%">2599.00</label></td>
                            </tr>
                            <tr>
					          <td><div id="goods3" style="margin:25%">206786</div></td>
                              <td><label id="trade-icon3"><img src="images/55b7540cNe946ed46.jpg" /></label></td>
                              <td>
                              	<label><a id="tradename3"> 【京东超市】沙宣洗发水修护水养750ml</a> </label>
                              	<label id="price3" style="margin-top:15px">￥2599.00</label></td>
					          <td>
                              	<div id="type31" class="trade-types">商品层级1</div>
                                <div id="type32" class="trade-types">商品层级2</div>
                                <div id="type33" class="trade-types">商品层级3</div>
                                <div id="type34" class="trade-types">商品层级4</div>
                              </td>	
                              <td><label id="buynum3" style="margin:40%">1</label></td>
					          <td><label id="amount3" style="margin-left:25%; margin-top:35%">2599.00</label></td>	
                             				     		         		</tr>
       ...
       <div style="float:left; margin-left:25px">订单信息</div>
		<div style="float:right; margin-right:42%">收货人信息</div>
    <div class="container">
    	
   <div class="panel panel-default">
					
					<div class="panel-body">
						<div style="float:left;width:46%; margin-right:50px"><table class="table table-hover table-bordered">
					     
					      <tbody>
					       <tr>
					          <td width="80px">支付方式</td>
                              <td><label>在线支付 </label></td>
					      </tr>
                           <tr>
					          <td>配送方式</td>
                              <td><label>普通快递 </label></td>
					      </tr>
                          <tr>
					          <td>快递单号</td>
                              <td><label>1120162421251</label></td>
					      </tr>
                           <tr>
					          <td>金额总计</td>
                              <td><label>69.00元 - 返现：0.00 + 运费：6.00元 - 使用余额：0.00元 = 订单总金额：75.00元 </label></td>
					      </tr>
                           <tr>
					          <td>下单时间</td>
                              <td><label>2016-07-12 10:22:22 </label></td>
					      </tr>
				          </tbody>
					    </table>
                        </div>
                        <div style="float:right; width:45%; margin-right:30px">
                        <table class="table table-hover table-bordered">
					     
					      <tbody>
					        <tr>
					          <td>收货人姓名</td>
                              <td><label>李华 </label></td>
					        </tr>
					       <tr>
					          <td>地址</td>
                              <td><label>浙江省杭州市下沙江干区杭州电子科技大学生活区 </label></td>
					      </tr>
                           <tr>
					          <td>固定电话</td>
                              <td>手机： <label>13500832933</label></td>
					      </tr>
                         <tr>
					          <td>电子邮箱</td>
                              <td><label>lihua@163.com </label></td>
					      </tr>
				          </tbody>
					    </table>
                        </div>
...
<!-- 按钮触发模态框 -->
<div style="margin-left:30px"><button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
	查看物流状态
</button>
<!-- 模态框（Modal） -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" >
		<div class="modal-content">
			...
			<div><div class="modal-body" style="float:left">
				该订单目前已送至：</div>
                <div style="float:left; margin-left:5px; margin-top:15px">
                杭州物流集散中心
             	</div>
                <div style="float:left;margin-top:15px; margin-left:20px">即将送往：</div>
...
<!-- Footer ================================================================== -->
 <!--***********************************************-->
      <div class="lazy-fn lazy-fn-done" id="lazy-footer" style="margin-top:20px;">
      <div id="service-2014">
