...
<div class="clear"></div>
<div class="container">
	<p class="fl">当前位置： &rsaquo; 在线充值</p>
    <div class="clear" style="height:50px;"></div>
    	<div class="left-div fl">
            <div class="fl">
                <button type="button" class="btn-danger" style="height:40px; width:120px;">账户充值</button>
            </div>
            <div class="clear fl">
                <button type="button" class="btn-danger" style="height:40px; width:120px;">网上充值</button>
            </div>
            <div class="clear fl">
                <button type="button" class="btn-danger" style="height:40px; width:120px;">银行转账</button>
            </div>
            <div class="clear fl">
                <button type="button" class="btn-danger" style="height:40px; width:120px;">转账汇款</button>
            </div>
            <div style="height:20px;" class="clear"></div>
            <div class="clear fl">
                <a href="#" style="padding-left:30px;">购买指南</a>
            </div>
            <div class="clear fl">
                <a href="#" style="padding-left:30px;">免费试用</a>
            </div>
            <div class="clear fl">
                <a href="#" style="padding-left:30px;">账户管理</a>
            </div>
    	</div>
        <div class="right-div">
            <a href="#"><img src="images/rightAD.jpg" style="width:80%; height:100px;" /></a>
            <h3 class="fl" style="margin-top:10px;"><strong>网上银行支付:</strong></h3>
            <div class="clear"></div>
            <div style="margin-top:-60px; margin-right:400px;">
            	充值账号: <input type="text" /><br />
                充值金额: <input type="text" /><br />
                <div style="height:40px;"></div>
                <a href="#"><button type="button" class="btn-primary par-btn">提交</button></a>
            </div>
        </div>
