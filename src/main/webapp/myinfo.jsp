...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="col-md-3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li class="active"><a href="myinfo.jsp">我的信息</a></li>
          <li><a href="coupon.jsp">我的优惠券</a></li>
          <li><a href="myvip.jsp">我的VIP</a></li>
        </ul>
      </div>
      <!--/.well --> 
    </div>
    ...
    <form class="form-inline" role="form" action="index.jsp">
    	<div>
        	
            用户名:<span>测试人员</span><br/>
            登录名:<span>admin<span style="margin-left:10%">可用于登录，请牢记哦~</span></span><br/>
            昵称:<input type="text" value="admin"/><br/>
            性别:<input type="radio" name="sex" />男<input type="radio" name="sex" />女<input type="radio" name="sex" checked="checked"/>保密<br/>
            生日:<input type="date" value="2016-09-01"/><br/>
            邮箱:<input type="email" value="123@qq.com" /><br/>
            真实姓名:<span>测试人员</span><br/>
        </div>
