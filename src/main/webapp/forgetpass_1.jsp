...
<!-- Sidebar end=============================================== -->
  ...
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 25%;">
    25%
		...
		<div>填写用户名</div>
			<form action="forgetpass_2.jsp">
            <table class = "table table-hover">
            <tbody>
            	<tr>
                	<td>账户名：</td>
                    <td><input type ="text" id = "username" name = "username" style="height:30px;" placeholder="用户名/邮箱/手机号"/>
                    	
                    </td>
                </tr>
                <tr>
                	<td>验证码:</td>
                    <td><input type ="text" id = "imgecode" name = "imgecode" style="height:30px;" placeholder="验证码"/> <img src="images/yzm.jpg"></td>
                    <td>看不清？<a>换一张</a></td>
                </tr>
