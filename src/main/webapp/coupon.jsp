    ...
    <div class="col-md-3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li class="active"><a href="coupon.jsp">我的优惠券</a></li>
    	...
    	<div class="jumbotron">
           <div class="demo">
            <div class="stamp stamp03">
                <div class="par"><p>XXXXXX折扣店</p><sub class="sign">￥</sub><span>50.00</span><sub>优惠券</sub><p>订单满300.00元</p></div>
                <div class="copy">副券<p>2015-08-13<br>2016-08-13</p></div>
                <i></i>
            </div>
            <a href="product_list.jsp" class="btn btn-info">立即使用</a>
