...
<div>设置新密码</div>
		<form action="forgetpass_4.jsp">
            <table class = "table table-hover">
            <tbody>
            	<tr>
                	<td>历史收货人姓名:</td>
                    <td><input type ="text" id = "hisname" name = "hisname"  style="height:30px;"value = "13588021122"/>
                    	
                    </td>
                </tr>
                <tr>
                	<td>新登录密码:</td>
                    <td><input type ="password" id = "pwd" name = "pwd"  style="height:30px;" placeholder="新密码"/> </td>
                </tr>
                <tr>
                <td>确认新密码:</td>
                    <td><input type ="password" id = "cpwd" name = "cpwd" style="height:30px;" placeholder="确认新密码"/>
                </tr>
