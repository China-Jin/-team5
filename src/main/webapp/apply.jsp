...
<div class="clear"></div>
    <div class="container">
        ...
        <p>请如实填写下列信息，便于您快捷办理贷款服务</p>
        <hr />
    </div>
    <div class="container">
    	<div>
        	<label class="apply_lable">贷款账号 *</label>
            <input type="text" style="margin-left:40px;" /></div>
        </div>
        <div style="height:10px;"></div>
        <div>
        	<label class="apply_lable">真实姓名 *</label>
            <input type="text" style="margin-left:40px;" /></div>
        </div>
        <div style="height:10px;"></div>
        <div>
        	<label class="apply_lable">身份证号 *</label>
            <input type="text" style="margin-left:40px;" /></div>
        </div>
        <div style="height:10px;"></div>
        <div>
        	<label class="apply_lable">贷款金额 *</label>
            <input type="text" style="margin-left:40px;" /></div>
        </div>
        <div style="height:10px;"></div>
        <div>
        	<label class="apply_lable">贷款期限 *</label>
            <input type="text" style="margin-left:40px;" placeholder="还款期限(单位：天)" /></div>
        </div>
        <div style="height:20px;"></div>
        <a href="#"><button type="button" class="apply-btn">提交</button></a>
    </div>
