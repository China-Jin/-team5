...
<div id="mainBody" style="background-color:#EEF0EE">
<div style="height:25px">&nbsp;</div>
<div>
	<div style="width:50%; margin-left:280px">
		<div class="label1" style="width:260px">订单提交成功，请您尽快付款！订单号：</div>
    	<div id="form_id" style="width:100px; float:left">342334232</div>
  		<div class="payAmount" id="payAmount">1000.00</div>
    	<div class="label1" style="float:right; margin-top:6px">应付金额：</div>
    	<div class="clear"></div>
	</div>
	<div style=" width:52%; margin-left:180px">
    	请您在提交订单后<font color="#EC73A9">一小时</font>内完成支付，否则订单将自动取消！
        <div style="float:right"><a href="订单内容">订单详情→</a>
		</div>
   </div>
	<div class="outblank">
	  <div class="main-part">
      	<div style="height:20px"></div>
        <div class="jd_pay">京东支付</div><div class="jd_pay" style="margin-left:30%; margin-top:-30px;">白条支付</div>
        <div class="in-part">
        	<div style="height:2px"></div>
       	  <div style="margin-top:8px; margin-left:8px">
            	<input type="checkbox" name="payway" id="payway" style="height:20px; float:left" />
              <div class="label1" style="margin-top:2px; font-size:16px">
        	可用余额
       		</div>
                <div style="float:left; margin-left:15px; margin-top:4px">
                	<div>
                    剩余<a class="shu"></a> <span id="balance">1200.00</span>&nbsp;元
                   </div>
                </div>
                <div id="payFor" class="payAmount" style="margin-right:6px">1000.00</div>
                <div class="label1" style="float:right; margin-top:6px">支付：</div>
          </div>
            
        	<div class="clear"></div>
            <div style="margin-top:6px; margin-left:8px; margin-bottom:5px">
            	<input type="checkbox" name="payway" id="payway" style="height:20px; float:left" />
                <div class="label1" style="margin-top:2px; font-size:16px">使用京豆</div>
                <div style="float:left; margin-left:15px; margin-top:4px">
                	<div>
                    剩余<a class="shu"></a> <span id="balance">1200.00</span>&nbsp;元
                   </div>
    ...
    <input type="password" class="form-control" id="payPWD" style="margin-right:40px" placeholder="输入支付密码">
   		 			</div>
			  </form>
		  </div>
            <button type="button" class="btn btn-primary btn-lg " style="background-color:#F53D6B; font-weight:bold; margin-top:10px; margin-right:420px;">   立 即 支 付 </button>
        </div>
        <div style="background-color:#099; margin-top:30px; margin-left:40px">
        	<ul class="header-right" style="margin-right:400px">
      			<li class="denglu"><a href="#">办理白条</a></li>
     			<li class="shu"></li>
      			<li class="denglu"><a href="#">一元抢大牌</a></li>
      			<li class="shu"></li>
      			<li class="shu"></li>
     			<li class="denglu"><a href="#">查看订单详情</a></li>
                <li class="shu"></li>
                <li class="denglu"><a href="#">试用plus会员</a></li>
    		</ul>
        </div>
          	<div>---------------------------------------------------------------------------------------------------------------</div>
            <div style="margin-top:15px; margin-left:20%; margin-right:25%">
            	<div class="label2" style="font-size:14px">重要提示：</div>
                <div>京东平台及销售商不会以订单异常、系统升级为由，要求您点击任何链接进行退款。<br/>请关注京东谨防诈骗公告 
				</div>
            </div>
   	  </div>
  </div>
