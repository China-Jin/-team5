  ...
  <div class="row-fluid">
    ...
    <div class="col-md-9">
    	<div class="jumbotron">
			<b>您的账户余额:</b>
            <b>1000</b>
           <a href="../../../b/模板/accounts_prepaid.html"> <button type="button" class="btn btn-success" title="账户充值" data-container="body" data-toggle="popover" 			        		data-placement="right" data-html="true" data-content="<!--您的银行卡账号:<br/><input type='text'></input><br/>您的银行卡密码:<br/><input type='password'></input><br/>充值金额:<br/><input type='text'></input><br/><button type='button' id='recharge'>确定</button>--><img src='images/11.jpg'/>">充值</button></a><br />
           <b>当前贷款:</b>
            <b>1000</b>
           <a href="baitiao.jsp"> <button type="button" class="btn btn-success" title="账户充值" data-container="body" data-toggle="popover" 			        		data-placement="right" data-html="true" data-content="<!--您的银行卡账号:<br/><input type='text'></input><br/>您的银行卡密码:<br/><input type='password'></input><br/>充值金额:<br/><input type='text'></input><br/><button type='button' id='recharge'>确定</button>--><img src='images/11.jpg'/>">还款</button></a>
        </div>
