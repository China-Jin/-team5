...
<div id="mainBody" >
	...
	<div class="row">
    <div><a>我的京东></a><a>订单中心></a>订单：<span >12275497588</span></div>
	
    <div class="container">
    	<h1 class="page-header">订单编号:12275497588</h1>
   <div class="panel panel-default">
					<div class="panel-heading col-md-8"> 
					<h4><strong>收货人信息</strong></h4>
						<p>
	               		  	 姓  名：李华<br>
	                  		 收货地址：浙江省 杭州市 下沙江干区 杭州电子科技大学生活区<br>
                             邮编：31001
                             <input type="button"  class="btn btn-warning btn-sm"value="修改收货地址"/><br />
	                		 联系电话：13588012323<br>
	                </p>
					</div>
					...
					<h4><strong>订单信息</strong></h4>
						<p >
	             		     支付方式：  <input type="checkbox" />立即支付    <input type="checkbox" />  京东白条<br /> 
                           
             		      
	            		     配送方式：快递运输<br>
                             <button class="btn btn-sm btn-danger">确认</button>&nbsp;&nbsp;&nbsp;
                          <button class="btn btn-sm btn-danger">取消订单</button> <br>
	            		     商家：京东自营<br/> 
	               	   </p>
					</div>
					<div class="panel-body">
						<table class="table table-hover table-bordered">
					      ...
					      <tbody>
					        <tr>
					          <td><label><img src="images/55b7540cNe946ed46.jpg" /></label></td>
                              <td><a href="#">Apple iPhone 6s (A1700) 64G 玫瑰金色 移动联通电信4G手机</a></td>
					          <td><label>￥2599.00</label></td>	
					          <td><label>1</label></td>
					          <td><label>￥2599.00</label></td>						     		         		   
					        </tr>
					        <tr>
					          <td><label><img src="images/56cd4890Ncb5e42dc.png"/></label></td>
                              <td><a href="#">Apple iPhone 6s (A1700) 64G 玫瑰金色 移动联通电信4G手机</a></td>
					        ...
					        <tr>
					          <td><label><img src="images/56978877N2cc43107.jpg"/></label></td>
                             <td><a href="#">Apple iPhone 6s (A1700) 64G 玫瑰金色 移动联通电信4G手机</a></td>
                            ...
                            <div>添加订单备注（请勿填写支付、收货、发票方面的信息）<br />
                            <textarea rows="4" cols="15" maxlength="45" placeholder="限45个字" ></textarea>
                            </div>
						</div>
					</div>
...
<!--	
    ...
    <div style="background-color:#71B247; height:3px;" ></div>
    	<div style="float:left; width:300px; height:200px;" class="aside_left">
            <div>订单号：<span>12275497588</span>
            </div>
            <div style="margin-top:100px;">
            <h3>订单完成提交</h3>
            </div>
        </div>
        <div style="float:right;width:600px; height:200px; " class="aside_right">
       		 <div >订单提交成功，感谢您在京东商城购物<a>是否去付款</a></div> 
        </div>
        <div class="clear"></div>
    </div>

    <div style=" margin-left:100px; margin-top:40px; width:900px; height:300px;">
        <div style="float:left; width:300px; height:200px;" class="aside_left1">
        </div>
        <div style="float:right;width:600px; height:200px; " class="aside_right1">
        </div>
