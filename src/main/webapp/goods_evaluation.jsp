...
<div class="container">
	<div class="backC">
    	<h2 style="margin-top:10px; margin-left:10px;">评价订单</h2>
        <div>
			<span class="mr20 mt10">订单号：<a  href="#" target="_blank" class="gray1">20611204322</a></span>
			<span>2016-07-24 10:17:29</span>
		</div>
    </div>
    <div class="shippingservice">
    	<div class="row">
            <div class="col-md-3">
                <div class="fl">
                	<img src="images/shippingcar.jpg" style="margin-left:20px;" />
                </div>
                <div class="pt20">
                	<h4><span>配送服务</span></h4>
                	<h6 class="mt20"><span>羞涩的配送小哥还没有更新个人信息</span></h6>
                </div>
            </div>
            <div class="col-md-3">
                	<p style="color:#FC982C;">请填写配送服务评价</p>
                    <p class="mt10 ml70">商品包装</p>
                    <div class="ml70 fr" style="margin-right:60px; padding-bottom:70px;">
                    	<a href="#"><button>1分</button></a>
                        <a href="#"><button>2分</button></a>
                        <a href="#"><button>3分</button></a>
                        <a href="#"><button>4分</button></a>
                        <a href="#"><button>5分</button></a>
                    </div>
            </div>
            <div class="col-md-3">
            	<div class="">
                    <p class="mt40 ml70">送货速度</p>
                    <div class="ml70 fr" style="margin-right:60px; padding-bottom:70px;">
                    	<a href="#"><button>1分</button></a>
                        <a href="#"><button>2分</button></a>
                        <a href="#"><button>3分</button></a>
    ...
    <div class="shippinggoods">
    	<div class="row">
        	<div class="col-md-3">
            	<img src="images/phone.jpg" />
                <a href="#"><p>金士顿(Kingston)低电压版 DDR3 1600 8GB 笔记本内存</p></a>
                <h4>￥305.20</h4>
            </div>
            <div class="col-md-9">
            	<div>
                	<p style="color:#FC982C; padding-right:600px;">请至少填写一件商品的评价</p>
                    <p class="mt10 ml70 fl" style="margin-left:50px;">商品满意度</p>
                    <ul>
                        <li class="fl ml40"><a href="#"><button>1分</button></a></li>
                        <li class="fl ml40"><a href="#"><button>2分</button></a></li>
                        <li class="fl ml40"><a href="#"><button>3分</button></a></li>
                        <li class="fl ml40"><a href="#"><button>4分</button></a></li>
                        <li class="fl ml40"><a href="#"><button>5分</button></a></li>
                    </ul>
                </div>
                <div class="clear"></div>
                <div>
                	<p class="mt10 ml70 fl" style="margin-left:50px;">买家印象 ：</p>
                    <div class="row fr">
                    	<div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="兼容性好" class="btn-group inputbtn" /></a>
                        </div>
                        <div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="待机时间长" class="btn-group inputbtn" /></a>
                        </div>
                        <div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="条子不错" class="btn-group inputbtn" /></a>
                        </div>
                        <div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="外观漂亮" class="btn-group inputbtn" /></a>
                        </div>
                        <div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="运行速度" class="btn-group inputbtn" /></a>
                        </div>
                        <div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="内存很大" class="btn-group inputbtn" /></a>
                        </div>
                        <div class="col-md-3 ptb">
                        	<a href="#"><input type="button" value="不卡屏" class="btn-group inputbtn" /></a>
                        </div>
    ...
    <div style="height:50px;"></div>
   <div class="container">
   		<a href="#"><button type="button" class="btn btn-primary" style="width:150px;">提交评价</button></a>
   </div>
   <div style="height:50px;"></div> 
</div>
<!-- MainBody End ============================= -->
