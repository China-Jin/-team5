					...
					<div class="panel-body">
						<table class="table table-hover table-bordered">
					      ...
					      <tbody>
					        <tr>
					          <td>206786</td>
                              <td><label><a> 【京东超市】沙宣洗发水修护水养750ml</a> </label></td>
					          <td><label>￥2599.00</label></td>	
                              <td><label>1</label></td>
					          <td><input type="button" class="btn btn-info btn-sm"  value="加入购物车"/></td>	
                              <td>
					...
					<div class="panel-body">
						<table class="table table-hover table-bordered">
					      ...
					      <tbody>
                           ...
                           <tr>
					          <td>取消时间</td>
                              <td><label>2016-07-12 11:22:22 </label></td>
					      </tr>
                          <tr>
					          <td>取消原因</td>
                              <td><label>主动取消订单 </label></td>
					      </tr>
					       </tbody>
					    </table>
					</div>
