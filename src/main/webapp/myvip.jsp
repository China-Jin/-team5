...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="col-md-3">
      <div class="well sidebar-nav">
        <ul class="nav nav-list">
          ...
          <li class="active"><a href="myvip.jsp">我的VIP</a></li>
        </ul>
      </div>
      <!--/.well --> 
    </div>
    ...
    <div class="col-md-9">
    	<div class="jumbotron">
          	<strong>您的会员级别是：</strong><span>注册会员</span><br/>
            <strong>会员级别有效期：</strong><span>长期有效（参与QQ会员秒变京东会员活动用户除外）</span><br/>
            成长值大于0后您即可升级为 <strong><a href="#">铜牌会员</a></strong>
        </div>
    </div>
    <!--/span--> 
  </div>
